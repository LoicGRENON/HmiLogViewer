...
class Ui_aboutDialog(object):
    def setupUi(self, aboutDialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/libertymap.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label.setPixmap(QtGui.QPixmap(_fromUtf8(":/ressources/HmiLogViewer_256.png")))
